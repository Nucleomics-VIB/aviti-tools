...
ax1.set_title(f'Distribution of Quasi-Black Pixel Counts (threshold ≤ {quasi_black_threshold})')
...
ax2.set_title(f'Quasi-Black Pixel Counts per Image (Sorted) (threshold ≤ {quasi_black_threshold})')
